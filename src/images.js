const images = [
  ...
  {
    id: 10,
    imageRef: require('./img/styled-components.png'),
  ...
  {
    id: 12,
    imageRef: require('./img/rxjs.svg'),
    title: 'RxJS',
    description: 'bar',
  },
  {
    id: 13,
    imageRef: require('./img/9.png'),
    title: 'Git',
    description: 'bar',
  },
  {
  ...
  {
    id: 16,
    imageRef: require('./img/gitkraken.svg'),
    title: 'GitKraken',
    description: 'bar',
  },
  {
...
export const imageLoader = () => images;
...
export const imageProjectsLoader = () => projectsImage;
